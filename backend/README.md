...
## Project Structure
    ...
    ├── testapiautoconnecto_65706  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_65706`
...
2. Clone this repo and `cd testapiautoconnecto_65706`
